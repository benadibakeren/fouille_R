...
Lors de la validation croisée nous avons remarqué une augmentation de la sensibilité pour la classe Joy(0.88) par rapport aux tests que nous avions fait juste avant,
cela peut laisser penser que le vocabulaire qui est associé à la joie dans ce dataset est devenu assez important dans le calcul bayésien.
