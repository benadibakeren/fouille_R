...
# On va enlever les lignes vides car il y a certaines descriptions qui sont vides
...
# On garde les catégories avec au moins 50 documents
df_clean <- df_clean %>%
...
# Sélection des variables numériques (termes TF-IDF)
X <- df_features[, -1]
...
# Création d'un dataframe avec les scores et la classe
df_lda <- data.frame(
  Subject = y,
  lda_scores
)
...
# Création d'un tableau récapitulatif des résultats de l'AFD avec tests de Wilks
...
# On retire les points pour un affichage plus lisible
